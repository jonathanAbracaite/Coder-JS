...
// lista de usuarios
let usuarios = [
  { DNI: "42942629", nombre: "Jonathan", contraseña: "12345678", saldo: 500 },
];

// creación de objetos
class Usuario {
  constructor(DNI, nombre, contraseña, saldo) {
    this.DNI = DNI;
    this.nombre = nombre;
...
function saludo(User) {
  ...
  divSaludo.innerHTML = `<h1>hola ${user.nombre}</h1>`;
}
...
function regaloNuevaCuenta(user){
  ...
  let notiRegalo = alertMsg(success, "Te regalamos $500 por registrarte con nosotros")
